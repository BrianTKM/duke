...
public class List {
    ...
    public void viewTasks(){
        ...
        {
            System.out.println(indentation + (i + 1) + ". [" + (taskList.get(i)).getStatusIcon() + "] "
    ...
    public void finishTask(int taskNumber){
        ...
        if(taskNumber >= 0 && taskNumber < taskList.size()){
            if(((taskList.get(taskNumber)).getStatusIcon()).equals("\u2713")){
                ...
                System.out.println(indentation + "[" + (taskList.get(taskNumber)).getStatusIcon() + "] "
                        + (taskList.get(taskNumber)).getTask());
            }
        }
        else
        {
